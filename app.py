...
def get_conversational_chain():
    prompt_template="""
    Answer the following question as best as possible within the required context, provide context or just say
...
def main():
    ...
    user_question = st.text_input("Ask a question based on PDF files input")
